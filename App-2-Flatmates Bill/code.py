...
class PdfReport:
    ...
    def generate(self, flatmate1, flatmate2, bill):
        flatmate1_pay = str(round(flatmate1.pays(flatmate2=flatmate2, bill=bill), ndigits=2))
        flatmate2_pay = str(round(flatmate2.pays(flatmate2=flatmate1, bill=bill), ndigits=2))
